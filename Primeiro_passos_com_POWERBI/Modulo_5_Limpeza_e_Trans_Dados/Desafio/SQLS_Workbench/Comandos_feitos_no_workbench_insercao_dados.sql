...
INSERT INTO employee 
VALUES
    ('Franklin', 'T', 'Wong', 333445555, '1955-12-08', '638-Voss-Houston-TX', 'M', 40000, 888665555, 5),  -- Wong tem Borg (888665555) como supervisor, que já foi inserido
    ('Jennifer', 'S', 'Wallace', 987654321, '1941-06-20', '291-Berry-Bellaire-TX', 'F', 43000, 888665555, 4);  -- Wallace tem Borg (888665555) como supervisor

-- Funcionarios que dependem dos supervisores a cima
INSERT INTO employee 
VALUES
    ('John', 'B', 'Smith', 123456789, '1965-01-09', '731-Fondren-Houston-TX', 'M', 30000, 333445555, 5),  -- Smith tem Wong (333445555) como supervisor, já inserido
    ('Ramesh', 'K', 'Narayan', 666884444, '1962-09-15', '975-Fire-Oak-Humble-TX', 'M', 38000, 333445555, 5),  -- Narayan tem Wong (333445555) como supervisor
    ('Joyce', 'A', 'English', 453453453, '1972-07-31', '5631-Rice-Houston-TX', 'F', 25000, 333445555, 5),  -- English tem Wong (333445555) como supervisor
    ('Ahmad', 'V', 'Jabbar', 987987987, '1969-03-29', '980-Dallas-Houston-TX', 'M', 25000, 987654321, 4);  -- Jabbar tem Wallace (987654321) como supervisor
...
SELECT 
    e.Super_ssn AS Gerente,
    COUNT(e.Ssn) AS Numero_de_Colaboradores
FROM 
    employee e
GROUP BY 
    e.Super_ssn;
